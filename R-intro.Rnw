...
\begin{versionhistory}
  \vhEntry{0.1}{\today}{SeungYeop\ Yang}{Created. I am planning to revise this document a couple of more times and release to the public as GPL/GFDL licensed document}
\end{versionhistory}
...
\begin{quotation}
\noindent
Copyright \copyright\  2011  SeungYeop Yang.
